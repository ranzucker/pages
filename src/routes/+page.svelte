<section class="bg-white dark:bg-gray-900">
  ...
  >
    <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
      ...
      <p class="mb-4">
        it took 20 seconds to bootstrap this website. you could make this your
        own by forking the github repo. either use a public repo, or pay the 14$
        to make the codebase private but still host it on github pages.
      </p>
      <p>
